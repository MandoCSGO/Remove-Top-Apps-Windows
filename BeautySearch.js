...
const SETTINGS = {acrylicMode:true,enhancedAcrylic:true,activityItemCount:'-1',disableTilesBackground:true,unifyMenuWidth:true,hideOutlines:true,hideUWPReviewShare:true,alwaysShowActivityPath:true,disableTwoPanel:true,adaptiveActivityCount:true,hideUserProfile:true,hideCloseButton:true,globalInstall:true,useController:true,theme:'dark',corners:'sharp',version2022:true};
