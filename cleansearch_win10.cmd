...
:: Variables
set "targetDir=C:\Windows\SystemApps\Microsoft.Windows.Search_cw5n1h2txyewy\cache\Local\Desktop"
...
echo.>> "%htmlFile%"
echo ^<script type="text/javascript" src="ms-appx-web:///cache/local/Desktop/CleanSearch.js"^>^</script^> >> "%htmlFile%"
